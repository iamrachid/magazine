            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <form method="POST" action="facture.php">
                        ...
                        <input id="send" type="submit" class="d-none">
                        <a type="button" class="btn btn-primary" onclick="validateCard(document.getElementById('creditcard').value,document.getElementById('expiration').value,document.getElementById('cvv').value)">Payer</a>
                    </form>
                </div>
            </div>
